...
visitors %>% 
  summarise(
    ...
    med_2022 = median(n_2021, na.rm = TRUE)
  )
```
...
**NA stands for "not applicable" due to no input, and this is the output because some of the entries in the column n_2021 have the value "NA".   **
...
**There exists extreme values as outliers to the right side of the distribution of data, causing the distribution of data to be skewered to the left side**
